...
//     echo "Already logged in as " . htmlspecialchars($_SESSION['user_name']);
        ...
        <form class="form shadow" action="" method="POST">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="remember">
                    <label class="form-check-label" for="remember">Remember me</label>
                </div>
                <a href="forgot-password.php" class="span text-decoration-none">Forgot password?</a>
            </div>

            <button type="submit" class="btn btn-dark w-100 mb-3 button-submit">Sign In</button>

            <p class="text-center p">Don't have an account? <a href="signup.php" class="span text-decoration-none">Sign Up</a></p>
            <p class="text-center p">Or With</p>
